...
export default function DeleteRequirementDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" role="dialog" aria-modal="true" aria-labelledby="delete-requirement-dialog-title">
      ...
      <div ref={containerRef} className="relative bg-white rounded-xl border border-gray-200 shadow-2xl w-full max-w-md p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 id="delete-requirement-dialog-title" className="text-lg font-semibold text-gray-900">Supprimer le poste</h3>
          <button
            onClick={onClose}
            aria-label="Fermer"
        ...
        <p className="text-sm text-gray-600 mb-4">
          Êtes-vous sûr de vouloir supprimer le poste <span className="font-semibold">{requirementName}</span> ?
        </p>
        <p className="text-xs text-gray-500 mb-4">
          Cette action est irréversible. Si des serveurs sont déjà confirmés pour ce poste, la suppression sera refusée.
        </p>
